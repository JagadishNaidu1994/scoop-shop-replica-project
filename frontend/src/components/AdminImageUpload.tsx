...
const AdminImageUpload: React.FC<AdminImageUploadProps> = ({
  ...
  if (!isAdminMode || !isEditingImages) {
    return children || <img src="/lovable-uploads/NR_Cup.png" alt={alt} className={className} style={style} />;
  }

  return (
    <div className="relative group inline-block">
      {children || <img src={preview || "/lovable-uploads/NR_Cup.png"} alt={alt} className={className} style={style} />}
