      ...
      <main className="w-full px-4 sm:px-6 lg:px-8">
        ...
        <div className="w-full py-16 text-center">
          ...
          <p className="text-xl text-gray-600 max-w-4xl mx-auto">
            Explore delicious ways to make matcha your daily thing—from iced
            lattes and coconut clouds to tonics that feel like a personality
            upgrade.
          </p>
          <p className="text-lg text-gray-500 max-w-3xl mx-auto mt-4">
            Discover matcha recipes with Nastea Rituals—signature drinks,
            café-level tips, and easy rituals for clean energy and smooth focus.
          </p>
        </div>
