    ...
    try {
      ...
      if (error) {
        ...
        toast({
          ...
          description: error.message || `Failed to sign in with ${provider}. Please check your internet connection and try again.`,
          variant: "destructive"
        });
      }
    } catch (error) {
              ...
              {!isLogin && (
                <div className="flex items-center space-x-2">
                  ...
                  <label htmlFor="terms" className="text-sm text-gray-600">
                    I agree to the <Link to="/terms-of-service" className="text-teal-600 hover:underline">Terms of Service</Link> and <Link to="/privacy-policy" className="text-teal-600 hover:underline">Privacy Policy</Link>
                  </label>
                </div>
              )}
