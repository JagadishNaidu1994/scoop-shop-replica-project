...
const HeaderNavBar = () => {
  ...
  return (
    <>
      {/* Top promotional banner - horizontally scrolling with responsive speed */}
      <div className="bg-gray-100 text-center py-2 text-sm font-medium text-black sticky top-0 z-50 overflow-hidden">
        <div className="whitespace-nowrap animate-[scroll-seamless_20s_linear_infinite] sm:animate-[scroll-seamless_15s_linear_infinite] lg:animate-[scroll-seamless_8s_linear_infinite]">
